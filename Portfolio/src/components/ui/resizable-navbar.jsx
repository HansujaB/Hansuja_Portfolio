      ...
      {items.map((item, idx) => (
        <a
          ...
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="absolute inset-0 h-full w-full rounded-full bg-gradient-to-r from-fuchsia-500 via-purple-600 to-indigo-600
               shadow-[0_0_10px_rgba(168,85,247,0.8),0_0_20px_rgba(147,51,234,0.6),0_0_40px_rgba(79,70,229,0.6)]" />
          )}
